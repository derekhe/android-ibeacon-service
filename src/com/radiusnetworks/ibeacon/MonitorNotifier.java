...
/**
 * This interface is implemented by classes that receive iBeacon monitoring
 * notifications
 * 
...
public interface MonitorNotifier {
	 ...
	 * 
	 * @param region
	 *            a Region that defines the criteria of iBeacons to look for
	 */
	 ...
	 * iBeacon in a <code>Region</code> is visible. Called with a state value of
	 * MonitorNotifier.OUTSIDE when no iBeacons in a <code>Region</code> are
	 * visible.
	 * 
	 * @param state
	 *            either MonitorNotifier.INSIDE or MonitorNotifier.OUTSIDE
	 * @param region
	 *            a Region that defines the criteria of iBeacons to look for
	 */
