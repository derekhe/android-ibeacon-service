...
public class IBeaconData extends IBeacon implements Parcelable {
	...
	public static Collection<IBeaconData> fromIBeacons(
			Collection<IBeacon> iBeacons) {
	...
	public static Collection<IBeacon> fromIBeaconDatas(
			Collection<IBeaconData> iBeaconDatas) {
