 ...
 * with <code>IBeaconManager</code> and provides a callback when the
 * <code>IBeaconService</code> is ready to use. Until this callback is made,
 * ranging and monitoring of iBeacons is not possible.
 * 
...
public interface IBeaconConsumer {
	/**
	 * Called when the iBeacon service is running and ready to accept your
	 * commands through the IBeaconManager
	 */
	public void onIBeaconServiceConnect();

	/**
	 * Called by the IBeaconManager to get the context of your Service or
	 * Activity. This method is implemented by Service or Activity. You
	 * generally should not override it.
	 * 
	...
	/**
	 * Called by the IBeaconManager to bind your IBeaconConsumer to the
	 * IBeaconService. This method is implemented by Service or Activity, and
	...
	/**
	 * Called by the IBeaconManager to unbind your IBeaconConsumer to the
	 * IBeaconService. This method is implemented by Service or Activity, and
	 * You generally should not override it.
	 * 
	 * @return the application context of your service or activity
